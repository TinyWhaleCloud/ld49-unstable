...
func _ready():
        stats = destination_stats.new('Shallow Space 7', 600, 0,0, 'Good', 'Recovery', 'A badly drawn, terribly "hidden" reference. But hey, people seem pretty friendly around here.', 1)
